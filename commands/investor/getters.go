...
var GetterCommands = []*cobra.Command{
	...
	&cobra.Command{
		...
		Example: "t0ken investor getAccreditation 0xf01ff29dcbee147e9ca151a281bfdf136f66a45b",
	...
	&cobra.Command{
		...
		Example: "t0ken investor getCountry 0xf01ff29dcbee147e9ca151a281bfdf136f66a45b",
		Args:    cli.AddressArgFunc("investor", 0),
		PreRun:  connectCaller,
		Run: func(cmd *cobra.Command, args []string) {
			investor := common.HexToAddress(args[0])
	...
	&cobra.Command{
		...
		Example: "t0ken investor getHash 0xf01ff29dcbee147e9ca151a281bfdf136f66a45b",
		Args:    cli.AddressArgFunc("investor", 0),
		PreRun:  connectCaller,
		Run: func(cmd *cobra.Command, args []string) {
			investor := common.HexToAddress(args[0])
	...
	&cobra.Command{
		...
		Example: "t0ken investor registry",
		Args:    cobra.NoArgs,
		PreRun:  connectCaller,
		Run: func(cmd *cobra.Command, args []string) {
